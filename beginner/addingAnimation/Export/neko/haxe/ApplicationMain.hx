...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AddingAnimation", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("AddingAnimation", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "AddingAnimation";
		app.meta["name"] = "AddingAnimation";
		app.meta["packageName"] = "com.sample.addinganimation";
